...
export default function Show(){
    ...
    function Deletefun (email) {
        axios.delete("https://samplehostspring-production.up.railway.app/delete", {params:{
            email: email
        }}).then((res)=>{
            alert(res.data);
            setResult(null)
    ...
    function saveEdit() {
        axios.put("https://samplehostspring-production.up.railway.app/update", {
    ...
    if(result == null) {
        axios.get("https://samplehostspring-production.up.railway.app/all", {}).then ((res)=>{
            setResult(res.data)
        })
    }
